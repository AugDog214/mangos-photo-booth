...
const PACKAGES_PROSE = `    <h2>Our packages</h2>
    <ul>
      <li><strong>Classic Booth — from $550.</strong> Two hours of open-air booth service, unlimited 2x6 or 4x6 prints, instant text &amp; email sharing, and a private online gallery.</li>
      <li><strong>Glamorous Booth — from $650.</strong> Everything in Classic plus a skin-perfecting beauty filter and an optional glam black &amp; white add-on.</li>
      <li><strong>Live Keychain Station — from $995.</strong> Guests watch their photos become custom keychains on the spot — 50 keychains included, with a dedicated attendant.</li>
      <li><strong>Magnet Station — from $995.</strong> A glam booth that prints 50 acrylic photo magnets your guests take home the same night.</li>
    </ul>
    <p>See full details on the <a href="../index.html#packages">packages page</a>, or <a href="../index.html#book">check your date</a> to lock in your booking.</p>`;
...
PAGES.push({
  ...
  description: "Luxury wedding photo booth and live-favor stations for Fort Myers, Cape Coral, Naples & Marco Island. Open-air booth from $550; keychain & magnet stations from $995. Prints in seconds, gallery in 48 hours.",
  ...
  answerParas: [
    "A wedding photo booth rental from Mango's starts at <strong>$550</strong> for a 2-hour open-air Classic Booth, with unlimited prints, instant sharing, and a private online gallery. The Glamorous Booth starts at $650, and our live-favor stations — the Live Keychain Station and Magnet Station — start at $995 with 50 keepsakes included.",
...
${PACKAGES_PROSE}`,
  ...
  faqs: [
    { q: "How much does a wedding photo booth cost?", a: "Wedding packages start at $550 for a 2-hour open-air Classic Booth. The Glamorous Booth starts at $650, and the Live Keychain and Magnet stations start at $995 with 50 keepsakes included. Final pricing depends on hours, backdrop, add-ons, and travel.", qPlain: "How much does a wedding photo booth cost?", aPlain: "Wedding packages start at $550 for a 2-hour open-air Classic Booth. The Glamorous Booth starts at $650, and the Live Keychain and Magnet stations start at $995 with 50 keepsakes included. Final pricing depends on hours, backdrop, add-ons, and travel." },
...
PAGES.push({
  ...
  answerParas: [
    "A corporate photo booth activation from Mango's starts at <strong>$550</strong> for a 2-hour open-air booth, scaling up with branded templates, custom backdrops, and live stations from $995. Pricing depends on hours, branding, add-ons, and travel within Southwest Florida.",
...
${PACKAGES_PROSE}`,
  ...
  faqs: [
    { q: "How much does a corporate photo booth cost?", a: "Corporate activations start at $550 for a 2-hour open-air booth, with branded stations from $995. Final pricing depends on hours, custom branding, add-ons, and travel.", qPlain: "How much does a corporate photo booth cost?", aPlain: "Corporate activations start at $550 for a 2-hour open-air booth, with branded stations from $995. Final pricing depends on hours, custom branding, add-ons, and travel." },
...
PAGES.push({
  ...
  answerParas: [
    "A birthday photo booth rental from Mango's starts at <strong>$550</strong> for a 2-hour open-air Classic Booth with unlimited prints and instant sharing. Glamorous, keychain, and magnet packages range up to $995. Customize any package to wow your guests.",
...
${PACKAGES_PROSE}`,
  ...
  faqs: [
    { q: "How much does a birthday photo booth cost?", a: "Birthday packages start at $550 for a 2-hour open-air Classic Booth, ranging up to $995 for our live keychain and magnet stations. Final pricing depends on hours, backdrop, add-ons, and travel.", qPlain: "How much does a birthday photo booth cost?", aPlain: "Birthday packages start at $550 for a 2-hour open-air Classic Booth, ranging up to $995 for our live keychain and magnet stations. Final pricing depends on hours, backdrop, add-ons, and travel." },
...
PAGES.push({
  ...
  answerParas: [
    "A quinceañera photo booth rental from Mango's starts at <strong>$550</strong> for a 2-hour open-air Classic Booth. Most quinces choose the Glamorous Booth (from $650) for its beauty filter, or a Live Keychain or Magnet Station (from $995) so every guest takes home a custom favor.",
  ...
  prose: `    <h2>Glamour for the guest of honor</h2>
    <p>Our Glamorous Booth adds a skin-perfecting beauty filter and an optional glam black &amp; white look, paired with a couture backdrop that matches your colors and theme. It's the photo moment every quinceañera deserves.</p>
...
${PACKAGES_PROSE}`,
  ...
  faqs: [
    { q: "How much does a quinceañera photo booth cost?", a: "Quinceañera packages start at $550 for a 2-hour open-air booth, with the Glamorous Booth from $650 and live keychain and magnet stations from $995. Final pricing depends on hours, backdrop, add-ons, and travel.", qPlain: "How much does a quinceanera photo booth cost?", aPlain: "Quinceanera packages start at $550 for a 2-hour open-air booth, with the Glamorous Booth from $650 and live keychain and magnet stations from $995. Final pricing depends on hours, backdrop, add-ons, and travel." },
    { q: "Do you have a beauty filter and custom backdrop?", a: "Yes. Our Glamorous Booth includes a skin-perfecting beauty filter and an optional glam black and white look, with a backdrop matched to your theme and colors.", qPlain: "Do you have a beauty filter and custom backdrop?", aPlain: "Yes. Our Glamorous Booth includes a skin-perfecting beauty filter and an optional glam black and white look, with a backdrop matched to your theme and colors." },
...
PAGES.push({
  ...
  answerParas: [
    "A holiday party photo booth rental from Mango's starts at <strong>$550</strong> for a 2-hour open-air Classic Booth with unlimited prints and instant sharing. Live keychain and magnet stations run up to $995 with 50 keepsakes included.",
...
${PACKAGES_PROSE}`,
  ...
  faqs: [
    { q: "How much does a holiday party photo booth cost?", a: "Holiday party packages start at $550 for a 2-hour open-air booth, ranging up to $995 for live keychain and magnet stations. Final pricing depends on hours, backdrop, add-ons, and travel.", qPlain: "How much does a holiday party photo booth cost?", aPlain: "Holiday party packages start at $550 for a 2-hour open-air booth, ranging up to $995 for live keychain and magnet stations. Final pricing depends on hours, backdrop, add-ons, and travel." },
...
function locationPage(slug, city, blurb, travelNote) {
  return {
    ...
    description: `Luxury photo booth rental in ${city}, FL. Weddings, corporate events, birthdays & quinceañeras. Open-air booth from $550; keychain & magnet stations from $995. Prints in seconds, gallery in 48 hours.`,
    ...
    answerParas: [
      `A photo booth rental in ${city} from Mango's starts at <strong>$550</strong> for a 2-hour open-air Classic Booth, including unlimited prints, instant sharing, and a private online gallery. The Glamorous Booth starts at $650, and the Live Keychain and Magnet stations start at $995 with 50 keepsakes included.`,
...
${PACKAGES_PROSE}`,
    ...
    faqs: [
      { q: `How much does a photo booth cost in ${city}?`, a: `In ${city}, packages start at $550 for a 2-hour open-air Classic Booth, with the Glamorous Booth from $650 and live keychain and magnet stations from $995. Final pricing depends on event size, hours, backdrop, add-ons, and travel.`, qPlain: `How much does a photo booth cost in ${city}?`, aPlain: `In ${city}, packages start at $550 for a 2-hour open-air Classic Booth, with the Glamorous Booth from $650 and live keychain and magnet stations from $995. Final pricing depends on event size, hours, backdrop, add-ons, and travel.` },
